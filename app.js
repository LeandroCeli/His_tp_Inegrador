...
const internacionRoutes =  require('./routes/internaciones');
...
app.use('/areaInternaciones',internacionRoutes);
...
app.get('/admision/paciente/buscar', requireLogin, (req, res) => res.render('admision/paciente'));
